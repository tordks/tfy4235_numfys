...
pylab.text(0.25, 4.05, '$dU = 0.1$', fontsize = 11, color = 'b')
pylab.text(0.25, 3.7, '$dU = 0.5$', fontsize = 11, color = 'g')
pylab.text(0.25, 3.4, '$dU = 10$', fontsize = 11, color = 'r')
pylab.text(0.25, 3.1, '$dt = 0.001$', fontsize = 11)
